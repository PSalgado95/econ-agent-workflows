...
If the input is empty, use `request_user_input` and ask:
...
If `request_user_input` is unavailable, ask concise numbered choices in chat, name the recommended conservative default, and wait for the user's answer for Class A choices.
