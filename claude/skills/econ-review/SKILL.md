...
If `AskUserQuestion` is unavailable, ask concise numbered choices in chat, name the recommended conservative default, and wait for the user's answer when the decision changes trust, promotion, baseline, interpretation, or validation scope.
